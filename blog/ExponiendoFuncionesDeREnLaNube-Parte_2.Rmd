...
> Si se ponen a ver las imágenes del proyecto Rocker, verán que hay imágenes que ya bienen preparadas para correr Shiny o RStudio Server directamente dockerizadas!!!
...
- Finalmente indicamos el comando princippal que se utilizará en la imagen a través de **ENTRYPOINT**.
...
**Hemos logramos encapsultar nuestra API mediante Docker!!!** Existen otrso beneficios de usar Docker pero deberán quedar para otros posteos en el futuro! :fire:
